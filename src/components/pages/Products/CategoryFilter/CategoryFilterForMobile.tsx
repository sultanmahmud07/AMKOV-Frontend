...
const CategoryFilterForMobile = ({ categories, categorySlug }: CategoryFilterProps) => {
        ...
        >
          {categories.map((category) => (
            ...
            >
              ...
              <span className="bg-secondary px-2 text-xs rounded-xl">10214</span>
            </div>
          ))}
        </RadioGroup>
      </div>
...
export default CategoryFilterForMobile;
